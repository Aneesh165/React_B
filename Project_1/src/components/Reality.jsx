...
function Reality() {
  return (
    <div className="text-center bg-gray-100 mt-20 pt-20">
      <h1 className="font-bold text-6xl">
        Turn your ideas into reality in <br /> seconds
      </h1>
      <p className="text-[1.45rem] text-gray-700 py-4 ">
        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
        dolore eu fugiat <br /> nulla pariatur excepteur sint occaecat
        cupidatat.
      </p>
      <section className=" py-8 mt-6 flex w-[100%]">
        <div className="w-[35%] flex flex-col gap-1 text-lg items-end">
          <button
            type="button"
            class="w-[250px] bg-[#3abab4] text-white hover:bg-white/90 hover:text-black focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded text-lg px-5 py-2 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 shadow-md group"
          >
            <svg
              class="w-6 h-6 me-2 group-hover:fill-[#3abab4]"
              aria-hidden="true"
